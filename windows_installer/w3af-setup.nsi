...
Section -MakeShortCuts
	...
	!insertmacro MUI_STARTMENU_WRITE_BEGIN Application
		...
		CreateShortCut "$SMPROGRAMS\$StartMenuFolder\readme\EN\w3af Users Guide (PDF).lnk" "$INSTDIR\readme\EN\w3af-users-guide.pdf"
		CreateShortCut "$SMPROGRAMS\$StartMenuFolder\readme\EN\w3af Users Guide (HTML).lnk" "$INSTDIR\readme\EN\w3af-users-guide.html"
		...
		CreateShortCut "$SMPROGRAMS\$StartMenuFolder\readme\FR\w3af Users Guide (PDF).lnk" "$INSTDIR\readme\FR\w3af-users-guide.pdf"
		CreateShortCut "$SMPROGRAMS\$StartMenuFolder\readme\FR\w3af Users Guide (HTML).lnk" "$INSTDIR\readme\FR\w3af-users-guide.html"
...
Function ShowReleaseNotes	
	ExecShell "open" "$INSTDIR\readme\EN\w3af-users-guide.html"
FunctionEnd
...
Function InstallExtLib
	...
	SetOutPath "$INSTDIR\extlib\nltk\"
	nsExec::ExecToLog '"$PYTHON_DIR\python.exe" "$INSTDIR\extlib\nltk\setup.py" install' ; http://www.nltk.org/Home
